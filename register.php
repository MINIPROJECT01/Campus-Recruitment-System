		...
		<div class="row"> 
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
			    ...
			    <div class="col-md-8">
			       ...
			       <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
			          "Contact No." type="tel" pattern = "[0-9]{10}"any value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
			    </div>
			  </div>
			</div> 
			 ...
			 <div class="form-group">
			  <div class="col-md-8">
			    <label class="col-md-4 control-label" for=
			    "SKILLSET">Skill set:</label>

			    <div class="col-md-8">
			      <select class="form-control input-sm" name="SKILLSET" id="SKILLSET">
